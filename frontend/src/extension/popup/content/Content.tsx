...
export function Content(props: { combinedConvertRequests: CombinedConvertRequest[] }) {
  ...
  const numberColClasses = 'w-[25] min-w-[25] mr-3 text-gray-300 light:text-slate-600';
  const nameColClasses = 'grow truncate mr-4 text-gray-50 light:text-gray-950';
  const sizeColClasses = 'w-[100] min-w-[100] mr-3 truncate text-gray-300 light:text-slate-600';
  const statusColClasses = 'w-[70] min-w-[70] mr-3 text-gray-300 light:text-slate-600';
